...
const DatabaseStatePage: React.FC = () => {
    ...
    const widgets: WidgetInfo[] = [
        ...
        { id: 'dead-tuples',         title: 'Мёртвые кортежи',          tooltip: 'Статистика по мертвым кортежам. Красная заливка — более 10% мёртвых.',   component: deadTuples.component,         onReload: deadTuples.reload,         isLoading: deadTuples.isLoading,        order: 8, fullWidth: true },
